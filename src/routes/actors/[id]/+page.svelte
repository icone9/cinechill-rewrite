...
<div class="movie-info border-b border-gray-800">
  <div class="mx-auto px-4 pb-16 pt-28 flex flex-col md:flex-row space-x-6">
    <div class="flex-none grid place-items-center md:place-items-start">
      <img src={`${TMDB_IMAGE_URL}/original${data.actor.profile_path}`} 
      class="w-64 lg:w-96 rounded-2xl"
      alt=""/>
      <ul class="flex items-center mt-4">
        {#if data.socials.facebook_id}
          <li>
            <a href={`https://facebook.com/${data.socials.facebook_id}`} title="Facebook" target="_blank">
              <svg class="fill-current  w-6 text-blue-700" viewBox="0 0 448 512"><path d="M448 56.7v398.5c0 13.7-11.1 24.7-24.7 24.7H309.1V306.5h58.2l8.7-67.6h-67v-43.2c0-19.6 5.4-32.9 33.5-32.9h35.8v-60.5c-6.2-.8-27.4-2.7-52.2-2.7-51.6 0-87 31.5-87 89.4v49.9h-58.4v67.6h58.4V480H24.7C11.1 480 0 468.9 0 455.3V56.7C0 43.1 11.1 32 24.7 32h398.5c13.7 0 24.8 11.1 24.8 24.7z"/></svg>
            </a>
          </li>
        {/if}
      </ul>
    ...
    <div class="text-center md:text-start">
      ...
      <div class="flex flex-wrap items-center text-gray-400 justify-center md:justify-start text-sm pt-4">
      ...
      <Spoiler
      content={data.actor.biography}
      class="text-gray-300 mt-6 flex flex-col items-center md:items-start"
      />
      <!-- <x-spoiler 
      ...
      <ul class="list-disc leading-loose pl-5 mt-8">
        {#each data.credits.cast as credit}
          <li>
            ...
            <strong>
                <a 
                href={credit.media_type === 'movie' ? `/movies/${credit.id}`: `/series/${credit.id}`} class="hover:underline text-primary">
                    {credit.title}
                </a>
            </strong>
